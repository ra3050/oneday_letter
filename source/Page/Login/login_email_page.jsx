...
const Login_email_page = props => {
  ...
  useFocusEffect(() => {
    const keyboardDidShowListener = Keyboard.addListener(
      'keyboardDidShow',
      e => {
        password_input_ref.current.measure(
    ...
    <Wrapper height={window_height} collapsable={false} wrapperTop={wrapperTop}>
      <Pressable
        ...
        <Wrapper_SafeArea>
          ...
          <Auth_Button_Box>
            <TouchableOpacity
              onPress={() => navigation.navigate('Login_Email_Sign')}>
              <Text style={styles.Auth_Text}>회원가입</Text>
            </TouchableOpacity>
            <Text style={styles.Auth_Text}>|</Text>
            <TouchableOpacity
              onPress={() => navigation.navigate('Login_Forgot_Eamil')}>
              <Text style={styles.Auth_Text}>아이디</Text>
            </TouchableOpacity>
            <Text style={styles.Auth_Text}>/</Text>
            <TouchableOpacity
              onPress={() => navigation.navigate('Login_Forgot_Password')}>
