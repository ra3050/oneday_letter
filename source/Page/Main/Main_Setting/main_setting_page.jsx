    ...
    <Wrapper>
      <ScrollView
        ...
        <User_Set_Container height={screenHeight * 0.45}>
          <User_Set_Image
            source={
              imageUri.dynamic
                ? { uri: imageUri.path }
                : require('../../../../resource/Letter/bg-diary-4-thumbnail.png')
            }
          />
          ...
          <View style={styles.gradientContainer}>
            <User_Set_Image_Choice_Button
              ...
              onPress={handleSaveUserImage}>
              <Icon
                name="plus"
                color="white"
                size={Math.round(screenWidth * 0.075)}
        ...
        <User_Letter_Choice_Container
          width={screenWidth - 32}
          height={Math.round(screenHeight * 0.075)}>
          <User_Send_Letter_Button
            ...
            <User_Send_Letter_Button_Title color={sendLt}>
              내가 쓴 편지
            </User_Send_Letter_Button_Title>
          </User_Send_Letter_Button>
          <User_Send_Letter_Button
            color={receiveLt}
            onPress={() => {
            ...
            <User_Send_Letter_Button_Title color={receiveLt}>
              내가 받은 편지
            </User_Send_Letter_Button_Title>
          </User_Send_Letter_Button>
        </User_Letter_Choice_Container>
