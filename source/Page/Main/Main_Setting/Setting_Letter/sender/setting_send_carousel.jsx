                ...
                {index == 0 ?
                    <>
                        <Header_Container width={screenWidth} key={index}>
                            <Setting_Send_Box item={item} style={{height: screenWidth, marginVertical: gap}}/>
                        </Header_Container> 
                    </>
                    :
                        <Setting_Send_Box item={item} style={{height: screenWidth, marginVertical: gap}} key={index}/>
                }
            </>
