...
/**
 * Main -> Main_Letter -> Letter_List -> letter_list_box 컴포넌트와 동일합니다
 * @param {item, style} props 
 * @returns 
 */
const Setting_Send_Box = (props) => {
    ...
    return  (
        <Wrapper height={height} marginVertical={marginVertical} onPress={() => handlePress()}>
            <Bg_Image source={getTemplateImage(bg_idx)}/>
            <Letter_Title numberOfLines={1} lineBreakMode="tail">{title}</Letter_Title>
            <Sub_Container>
...
export default Setting_Send_Box;