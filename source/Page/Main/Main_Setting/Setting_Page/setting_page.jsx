  ...
  const handleAlertPush = () => {
    get_usreIdx(mb_idx => {
      if (mb_idx) {
        const info = {
          mb_idx: mb_idx,
          alert: { name: 'alert_push', value: !alert_push },
        };
    ...
    <Wrapper>
      ...
      <Options_Container ratios={1}>
        <Option_Button
          ratios={1}
          onPress={() =>
            navigation.navigate('Login_Interest_Choice', { category: category })
          }>
      ...
      <Options_Container ratios={1}>
        <Option_Button
          ratios={1}
          onPress={() =>
            navigation.navigate('Login_Personality_Choice', {
              category: category,
            })
          }>
