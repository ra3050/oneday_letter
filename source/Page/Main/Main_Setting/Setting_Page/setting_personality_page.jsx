...
import { Pressable, SafeAreaView, View, Text, Dimensions, TouchableOpacity } from "react-native";
...
const Setting_Personality_Page = (props) => {
    ...
    return (
        <Wrapper>
            <Wrapper_Safe>
                <Title_Container>
                    <Title>{'난 '}<Title_Sub>이런 사람</Title_Sub>{'이야'}</Title>
                    <Title_Button_Container>
                        <Title_Button>
                            <Title_Button_Text>{personality[0] ? personality[0] : ''}</Title_Button_Text>
                        </Title_Button>
                        <Title_Button>
                            <Title_Button_Text>{personality[1] ? personality[1] : ''}</Title_Button_Text>
                        </Title_Button>
                        <Title_Button>
                            <Title_Button_Text>{personality[2] ? personality[2] : ''}</Title_Button_Text>
                        </Title_Button>
                    </Title_Button_Container>
                    <Line_View width={screenWidth}/>
                    <Descrypt>{'나의 성격을 선택해주세요'}</Descrypt>
                </Title_Container>
                <Personality personality={personality} setPersonality={setPersonality} style={{width: screenWidth, height: Math.round(screenHeight * 0.6)}}/>
            </Wrapper_Safe>
        </Wrapper>
    )
}
