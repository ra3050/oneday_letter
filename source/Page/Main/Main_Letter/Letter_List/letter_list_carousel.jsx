...
import { View, FlatList, Dimensions, Platform, Text, SafeAreaView, StyleSheet, Pressable } from "react-native";
            ...
            <SafeAreaView>
                {index == 0 ?
                    ...
                    {/* <Header_Container width={screenWidth}>
                        ...
                        <Letter_List_Box item={item} style={{height: screenWidth, marginVertical: gap}}/>
                    </>
                    :
                        <Letter_List_Box item={item} style={{height: screenWidth, marginVertical: gap}}/>
                }
