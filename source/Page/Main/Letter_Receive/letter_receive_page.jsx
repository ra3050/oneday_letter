...
import { TextInput, ScrollView, Dimensions, TouchableOpacity, Keyboard, KeyboardAvoidingView, Pressable } from "react-native";
...
const Letter_Receive_Page = (props) => {
        ...
        if (letterText.length < 10) {
            ...
            get_usreIdx(mb_idx => {
                const receive_letterInfo = {
                    mb_idx: mb_idx,
                    receiver_mb_idx: letterInfo.mb_idx ? letterInfo.mb_idx : letterInfo.sender_mb_idx,
                    receiver_mb_nick: letterInfo.mb_nick,
                    root_lt_idx: letterInfo.lt_idx ? letterInfo.lt_idx : letterInfo.root_lt_idx,
                    content: letterText,
                }
    ...
    return (
        <Wrapper height={screenHeight - keyboardHeight - headerHeight}>
            ...
            <Toast ref={toastRef}
                positionValue={keyboardHeight ? screenHeight - keyboardHeight - headerHeight + 100 : screenHeight * 0.35}
                fadeInDuration={200}
