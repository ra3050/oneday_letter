  ...
  return (
    <Wrapper width={width} height={height}>
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[0].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(0)}>
      ...
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[1].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(1)}>
          <Personality_Text>{info[1].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[2].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(2)}>
      ...
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[3].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(3)}>
          <Personality_Text>{info[3].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[4].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(4)}>
          <Personality_Text>{info[4].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[5].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(5)}>
      ...
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[6].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(6)}>
          <Personality_Text>{info[6].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[7].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(7)}>
          <Personality_Text>{info[7].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[8].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(8)}>
      ...
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[9].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(9)}>
          <Personality_Text>{info[9].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[10].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(10)}>
          <Personality_Text>{info[10].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[11].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(11)}>
      ...
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[12].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(12)}>
          <Personality_Text>{info[12].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[13].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(13)}>
      ...
      <Personality_Container>
        <Personality_Button
          backgroundColor={info[14].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(14)}>
          <Personality_Text>{info[14].text}</Personality_Text>
        </Personality_Button>
        <Personality_Button
          backgroundColor={info[15].backgroundColor}
          width={buttonWidth}
          height={buttonHeight}
          onPress={() => handle_personality_button(15)}>
